...
class Settings:
    ...
    ability_mechanic_categories_path: Path = PROJECT_ROOT / "config" / "ability_mechanic_categories.json"
    ability_infobox_path: Path = PROJECT_ROOT / "config" / "ability_infobox_mainline.json"
    battle_states_path: Path = PROJECT_ROOT / "config" / "battle_states_mainline.json"
